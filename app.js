...
const episodes = [
  ...
  // ── EP 09 はじめまして ──────────────────────────
  {
    ...
    pages: [
      ...
      {
        image: "scene1.webp", audio: "s1.mp3",
        jpHtml: r(`<span class="sp">渡辺</span>　{土曜日|どようび}の{夜|よる}、うちでパーティーをします。よかったら{来|き}てください。<br><span class="sp">邵</span>　あ、ありがとうございます。お{花|はな}を{持|も}っていきます。`),
        zhText: "渡辺：周六晚上我在家搞个派对，方便的话请来玩。\n邵：啊，谢谢您。我带点花去。",
        vocab: [
      ...
      {
        image: "scene2.webp", audio: "s2.mp3",
        jpHtml: r(`<span class="sp">渡辺</span>　邵さん、{紹介|しょうかい}しますね。こちらは{鈴木|すずき}さん、{前|まえ}の{会社|かいしゃ}の{同僚|どうりょう}です。<br><span class="sp">邵</span>　はじめまして、{邵|しゃお}と{申|もう}します。よろしくお{願|ねが}いします。<br><span class="sp">鈴木</span>　はじめまして、{鈴木|すずき}と{申|もう}します。よろしくお{願|ねが}いします。`),
        zhText: "渡辺：邵，给你介绍一下，这位是铃木，我上一家公司的同事。\n邵：初次见面，我叫邵，请多关照。\n铃木：初次见面，我叫铃木，请多关照。",
        vocab: [
          { jp: "紹介する",            reading: "しょうかいする",       zh: "介绍",          grammar: "動詞" },
          { jp: "同僚",                reading: "どうりょう",           zh: "同事",          grammar: "名詞" },
      ...
      {
        image: "scene3.webp", audio: "s3.mp3",
        jpHtml: r(`<span class="sp">邵</span>　{鈴木|すずき}さんはどんなお{仕事|しごと}をしていますか？<br><span class="sp">鈴木</span>　{病院|びょういん}で{看護師|かんごし}をしています。`),
        zhText: "邵：铃木小姐是做什么工作的？\n铃木：我在医院做护士。",
        vocab: [
          { jp: "どんな〜", reading: "どんな〜",   zh: "什么样的〜", grammar: "表現" },
          { jp: "病院",     reading: "びょういん", zh: "医院",       grammar: "名詞" },
          { jp: "看護師",   reading: "かんごし",   zh: "护士",       grammar: "名詞" },
        ]
      },
      {
        image: "scene4.webp", audio: "s4.mp3",
        jpHtml: r(`<span class="sp">邵</span>　{看護師|かんごし}ですか。{忙|いそが}しいですね。<br><span class="sp">鈴木</span>　そうですね。でも、{看護師|かんごし}になるのは、{小|ちい}さい{頃|ころ}の{夢|ゆめ}でしたよ。邵さんのお{仕事|しごと}、{偉|えら}いですね。`),
        zhText: "邵：护士啊，很忙吧。\n铃木：是呢。不过成为护士是我小时候的梦想。邵先生的工作也很了不起呢。",
        vocab: [
          { jp: "〜になるのは", reading: "〜になるのは", zh: "成为〜这件事", grammar: "表現" },
          { jp: "小さい頃",     reading: "ちいさいころ", zh: "小时候",       grammar: "表現" },
          { jp: "夢",           reading: "ゆめ",         zh: "梦想",         grammar: "名詞" },
          { jp: "偉い",         reading: "えらい",       zh: "了不起",       grammar: "イ形容詞" },
        ]
      },
      {
        image: "scene5.webp", audio: "s5.mp3",
        jpHtml: r(`<span class="sp">邵</span>　あははは、{話|はな}せば{長|なが}くなりますよ。あっちで{飲|の}みながら{話|はな}しましょうか。`),
        zhText: "邵：哈哈哈，说来话长。我们到那边一边喝点酒一边聊吧。",
        vocab: [
          { jp: "話せば長くなる", reading: "はなせばながくなる", zh: "说来话长",     grammar: "表現" },
          { jp: "〜ながら",       reading: "〜ながら",           zh: "一边〜一边〜", grammar: "表現" },
          { jp: "〜ましょうか",   reading: "〜ましょうか",       zh: "要不要〜？",   grammar: "表現" },
        ]
      },
    ]
  }
